...
/* function imprimirTablaMultiplicar(multiplo) {
  for (let i = 0; i <= 10; i++) {
...
/* function imprimirTodasLasTablas(){
...
function sumarArray(arr) {
  ...
  console.log(`El resultado de la suma de los números del 1 al 10 es ${sumaArr}`);
}
sumarArray(arr); */
...
/* function calcularFactorial(numero) {
  ...
  console.log(`${numero}! factorial es ${resultado}`);
}
...
/* function convertirCelsiusAFarenheit(gradosCelsius) {
  ...
  console.log(`${gradosCelsius}ºC son ${gradosFarenheit}ºF`);
}
...
/* function convertirFarenheitACelsius(gradosFarenheit) {
  let gradosCelsius = (gradosFarenheit  - 32) / 1.8;
  console.log(`${gradosFarenheit}ºF son ${gradosCelsius}ºC`);
}

convertirFarenheitACelsius(68); */
...
function sumarArray(arr) {
  ...
  console.log(`El resultado de la suma de ${arr} es ${sumaArr}`);
}
sumarArray(arr); */
...
function calcularPromedioArray(arr) {
  ...
  let resultado = sumaArr / arr.length;
  console.log(resultado);

}

calcularPromedioArray(arr); */

//Desafío de programación #12: Crea una función que reciba un array de números y devuelva un array conteniendo solo los números positivos

/* function devolverNumerosPositivos(arr) {
  let positiveArray = [];
...
const array = [-1, 10, -4, 20, 8, 2, -99];

devolverNumerosPositivos(array); */
...
const array = [1, 1000, 45, -20, 890, 22, 599];
encontrarMax(array); */

//console.log(Math.max(...array)); //Spread syntax
